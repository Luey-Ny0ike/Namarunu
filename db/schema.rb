...
ActiveRecord::Schema[8.2].define(version: 20_260_226_165_043) do
  ...
  create_table 'users', force: :cascade do |t|
    ...
    t.index %w[full_name email_address role], name: 'index_users_on_full_name_and_email_address_and_role'
  end
